...
:: This is simple windows flashing script for Sony Xperia 1/5 device
...
echo(
echo This is a Windows flashing script for Sony Xperia 1 or 5 device.
echo(
...
echo "Software binaries for AOSP Android 11.0 - Kernel 4.14 - Kumano"
